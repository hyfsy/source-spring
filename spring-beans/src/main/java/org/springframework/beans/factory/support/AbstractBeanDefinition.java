...
public abstract class AbstractBeanDefinition extends BeanMetadataAttributeAccessor
	...
	public void overrideFrom(BeanDefinition other) {
		...
		// 用other的bean定义信息来覆盖调用方法的bean定义信息
	 ...
	 * 主要是用来帮助自动代理的创建
	 * @see ConfigBeanDefinitionParser#createPointcutDefinition
	 * @see ConfigBeanDefinitionParser#parseAdvice
	 */
	 ...
	 * 该bean定义是人工合成的，而不是应用程序本身定义的，如果是用户定义则为 true,否则为 false
	 * @see #setSynthetic
	 */
	...
	public void validate() throws BeanDefinitionValidationException {
		// bean定义中不能同时存在 方法重写（@Lookup） 和 工厂方法
