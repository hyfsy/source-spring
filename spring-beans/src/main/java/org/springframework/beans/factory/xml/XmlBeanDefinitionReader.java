...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
	...
	/**
	 * Indicates that DTD validation should be used. DTD 验证模式
	 */
	public static final int VALIDATION_DTD = XmlValidationModeDetector.VALIDATION_DTD;

	/**
	 * Indicates that XSD validation should be used. XSD 验证模式
	 */
	...
	/**
	 * 决定使用哪个 NamespaceHandler 来处理对应的命名空间（xsd/dtd(用的少)）
	 */
	@Nullable
    ...
    /**
     * XML EntityResolver 解析器，处理 XSD/DTD文件的资源获取（默认类路径查找、网络下载）
     */
	@Nullable
	private EntityResolver entityResolver;

    /**
     * XML ErrorHandler 处理器
     */
	...
	public int registerBeanDefinitions(Document doc, Resource resource) throws BeanDefinitionStoreException {
		...
		// 从 DefaultListableBeanFactory 中获取已注册的 BeanDefinition 数量
